...
if (isset($_POST['give_attendance'])) {
    ...
    if( (in_array($ip, $ip_Array) or $test==1) or ($ip=='103.86.111.193' && in_array($user_id, $rampura_user_id) )){
    extract($_REQUEST);
...
if (isset($_POST['late_attandance'])) {
      if(in_array($ip, $ip_Array) or ($ip=='103.86.111.193' && in_array($user_id, $rampura_user_id) ) ){
    extract($_REQUEST);
        ...
        <div class="container-fluid">
            ...
            <div class="col-md-6 col-lg-6">
                <div class="panel panel-success">
                    ...
                    <?php  if(in_array($ip, $ip_Array) or  ($ip=='103.86.111.193' && in_array($user_id, $rampura_user_id) )   ){ ?>
                            <div class="row">
                            ...
                            <div class="form-group row mb-0 text-center">
                              <br/>
                                ...
                                <?php
                                  //In time  for  office
                                  $time = date('H:i:s',strtotime("10:01:00 AM"));
