                                       ...
                                       <a href="emp_detail.php?emp_id=<?php echo $data['user_id']; ?>"
                                        ...
                                        <td class="text-center" width="80px">
                                                                                        ...
                                                                                        <a href="edit_emp.php?edit_emp_id=<?php echo $data['user_id']; ?>"
                                                                                           ...
                                                                                           <a type="button" title="User Inactive" onclick="user_deactive(<?php echo $data['user_id']; ?>);" class="btn btn-danger btn-sm text-center"><i class="fa fa-user-times"></i></a>
...
<script type="text/javascript">
        ...
        function user_deactive(user_id){
           ...
           $.ajax({
                    ...
                    success: function (response) {
                       ...
                       if (response=='1') {
                            ...
                            alert('This User Inactive Successfully');

                            location.reload(true);

                       }else{

                        alert(' User Inactive Failed');
