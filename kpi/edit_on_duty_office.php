...
$userid =$_SESSION['user_id'];
 ...
 $select_sql = "SELECT att.emp_id, att.`date`, usr.name FROM `attendance` att left join users usr on att.emp_id = usr.id WHERE att.on_duty_status = 1 and att.id = '$get_id' ";

$select_q = mysqli_query($connection, $select_sql);
$select_f = mysqli_fetch_array($select_q);


   $emp_id = $select_f['emp_id'];
 $date = $select_f['date'];
  $name = $select_f['name'];
  ...
  if (isset($_POST['submit'])) {
  		...
  		$update_sql ="UPDATE `attendance` set emp_id = '$select_emp', `date`='$date' where id='$get_id' ";
        ...
        <div class="container-fluid">
            ...
            ?>
                <div class="panel panel-default">
                    <div class="panel-heading">Edit On Duty Office </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                     ...
                                     <div class="form-group row">
                                     	<input type="hidden" name="edit_id" value="<?php echo $get_id;  ?>">
