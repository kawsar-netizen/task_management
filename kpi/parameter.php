                                ...
                                <tr>
                                    <td>  
                                      ...
                                      <input type="radio" name="month_or_date" 
                                        <?php   if($data['marks_generate']==1){echo "checked";}   ?> > 
                                      ...
                                      > <label>Weekly / Daily :</label> 
                                    </td>

                                    <td><?php  echo $data['holiday_office']; ?>  Days</td>

                                    <td><?php  echo $data['overtime']; ?>   Hours  </td>

                                   
                                    <td><a href="<?php echo $global_url; ?>/kpi/edit_parameter.php?id=<?php echo $data['id']; ?>" class="btn btn-primary btn-sm">Edit</a></td>
